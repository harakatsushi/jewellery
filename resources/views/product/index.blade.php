...
@extends('layouts.app', ['title' => '制作実績'])
			...
			<main id="cont_main">
				...
				<section id="sec_prod" class="mid_sec">
					...
					<ul class="prod_li mode02">
						...
						<li><button  onclick="addBookmark('product',{{$product->id}})" class="btn_favo mode_s @if($bookmarks && $bookmarks->contains('item_id',$product->id)) active @endif"></button><a href="/jeweller/product/detail/{{$product->id}}"><img src="/upload/profile/{{$product->image}}" alt=""></a></li>
						@endforeach
					</ul>
					<nav class="pager">
