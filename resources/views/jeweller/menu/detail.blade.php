...
@extends('layouts.app', ['title' =>$menu->name .'｜作品一覧｜'.$jeweller->name.'さん｜在籍ジュエラー'])
			...
			<div class="container">
				...
				<nav class="breadcrumbs">
					<ul>
						...
						<li><a href="/jeweller/{{$jeweller->id}}/menu">メニュー一覧</a></li>
						<li>メニュー名</li>
					</ul>
				</nav>
			</div>
				...
				<section id="my_favo" class="mid_sec">
					...
					@if($menu->sub_img1)
						<div class="postscript_box txt_box">
							<div class="img_box">
								<img src="/upload/profile/{{$menu->sub_img1}}" alt="{{$menu->name}}">
							</div>
							<p>
								{{$menu->annotation01}}
							</p>
						...
						<div class="postscript_box txt_box">
							<div class="img_box">
								<img src="/upload/profile/{{$menu->sub_img2}}" alt="{{$menu->name}}">
							</div>
							<p>
								{{$menu->annotation02}}
							</p>
						...
						<div class="postscript_box txt_box">
							<div class="img_box">
								<img src="/upload/profile/{{$menu->sub_img3}}" alt="{{$menu->name}}">
							</div>
							<p>
								{{$menu->annotation03}}
							</p>
						...
						<dl class="price_box">
							...
							<dd>
								{{number_format($menu->price)}}円 @if($menu->price_option==2) ～ @endif
							</dd>
						</dl>
						@endif
					</div>
					<p class="btn_mt btn_mb">
						<a href="/mymenu/message/detail/menu/{{$menu->id}}" class="btn01">
