...
<html lang="ja">
    <head>
        ...
        @if(isset($title))
        <title>{{$title}}｜オリジナルジュエリー制作「ai-jewelly」</title>
        @else
        ...
        @if(isset($css))<link rel="stylesheet" href="/assets/css/{{$css ?? 'price'}}.css">@endif
        ...
        <header id="header">
            <div id="seo">
                <div class="pc_container">
                    ...
                    @if(isset($title))
                    <h1><span>{{$title}}｜オリジナルジュエリー制作をオンラインで「ai-jewelly」</span></h1>
                    @else
