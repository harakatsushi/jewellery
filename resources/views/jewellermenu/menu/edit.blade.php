@extends('layouts.app', ['title' => '【編集】'.$menu->name.'｜作品登録｜ジュエラーメニュー','css'=>'mymenu'])
       ...
       @if (count($errors) > 0)
          ...
          @endif
								<dl>
									...
									<dd>
										<div class="img_box mode_thum btn_mb">
											<img src="/upload/profile/{{$menu->image}}" alt="" id="preview">
										</div>
								...
								<dl>
									...
									<dd>
										<div class="img_box mode02 btn_mb @if(!$menu->sub_img1) disp_n @endif">
											<img src="/upload/profile/{{$menu->sub_img1}}" alt="" id="preview01">
										</div>
										<div class="file_input">
								...
								<dl>
									...
									<dd>
										<div class="img_box mode02 btn_mb  @if(!$menu->sub_img2) disp_n @endif">
											<img src="/upload/profile/{{$menu->sub_img2}}" alt="" id="preview02">
										</div>
										<div class="file_input">
								...
								<dl>
									...
									<dd>
										<div class="img_box mode02 btn_mb  @if(!$menu->sub_img3) disp_n @endif">
											<img src="/upload/profile/{{$menu->sub_img3}}" alt="" id="preview03">
										</div>
										<div class="file_input">
