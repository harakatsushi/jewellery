			...
			<div class="container">
				...
				<nav class="breadcrumbs">
					...
					<li><a href="/">ai-jewelly TOPページ</a></li>
						...
						<li><a href="/orderreceived/">受注履歴</a></li>
		...
		<div id="cont_wrapper" class="container u_page">
			...
			@if($message->order)
						...
						<dl>
							...
							<dd>
								<a href="/user/profile/{{$message->user_id}}">{{$message->user->name}}</a>
							</dd>
						</dl>
						<dl>
							<dt>
						...
						<dl>
							...
							<dd>
								<a href="/jewellermenu/message/detail/{{$message->id}}">ai-jewelly.com/mymenu/message/detail/{{$message->id}}</a>
							</dd>
						</dl>
						<dl>
							<dt>
