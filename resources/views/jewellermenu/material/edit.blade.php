...
@extends('layouts.app', ['title' => '【編集】'.$material->name.'｜素材・デザイン登録｜ジュエラーメニュー','css'=>'mymenu'])
		...
		<div id="cont_wrapper" class="container u_page">
          ...
          @endif
								<dl>
									...
									<dd>
										<div class="img_box mode_thum btn_mb">
											<img src="/upload/profile/{{$material->image}}" alt="" id="preview">
										</div>
								...
								<dl>
									...
									<dd>
										<div class="img_box mode02 btn_mb @if(!$material->sub_img1) disp_n @endif">
											<img src="/upload/profile/{{$material->sub_img1}}" alt="" id="preview01">
										</div>
										<div class="file_input">
								...
								<dl>
									...
									<dd>
										<div class="img_box mode02 btn_mb  @if(!$material->sub_img2) disp_n @endif">
											<img src="/upload/profile/{{$material->sub_img2}}" alt="" id="preview02">
										</div>
										<div class="file_input">
								...
								<dl>
									...
									<dd>
										<div class="img_box mode02 btn_mb  @if(!$material->sub_img3) disp_n @endif">
											<img src="/upload/profile/{{$material->sub_img3}}" alt="" id="preview03">
										</div>
										<div class="file_input">
