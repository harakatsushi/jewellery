				...
				<section id="my_history" class="mid_sec">
					...
					<div class="order_history_box table_style">
						...
						<dl>
							...
							<dd>
								<a href="/user/{{$message->user_id}}">{{$message->user->name}}</a>
							</dd>
						</dl>
						<dl>
							<dt>
							...
							<dd>
								<ul>
									<li>
										<a href="../jeweller/detail.html">jeweller_name</a>
									</li>
									<li>
										<a href="../jeweller/detail.html">jeweller_name</a>
									</li>
						...
						<dl>
							...
							<dd>
								<a href="/operationmenu/message/read_only/{{$message->id}}">観覧専用ページ</a>
							</dd>
						</dl>
						<dl>
							<dt>
...
テキストが入ります。</pre>
						...
						<dl>
							...
							<dd>
								<a href="../user/detail.html">user_name</a>
							</dd>
						</dl>
						<dl>
							<dt>
						...
						<dl>
							...
							<dd>
								<a href="../message/read_only.html">観覧専用ページ</a>
							</dd>
						</dl>
						<dl>
							<dt>
