...
@extends('layouts.app', ['title' => '公開依頼一覧｜作品登録｜ジュエラーメニュー'])
					...
					<form action="" method="get">
						<p class="sort_box">
							<select name="" id="" onchange="chgSort('order',this.value)">
								<option value="0" @if($sort_number==0) selected @endif>新着順</option>
								<option value="1" @if($sort_number==1) selected @endif>締切りが遠い順</option>
								<option value="2" @if($sort_number==2) selected @endif>締切りが近い順</option>
								<option value="3" @if($sort_number==3) selected @endif>予算が高い順</option>
								<option value="4" @if($sort_number==4) selected @endif>予算が安い順</option>
							</select>
						</p>
						<ul class="favo_li mode_order">
							...
							<li>
								<div class="left">
									...
									<p class="date">あと<span class="bold">{{$order->limit_span()}}</span>日</p>
								</div>
								<div class="data">
									<ul class="tag_li">
									...
									<a href="/order_list/detail/{{$order->id}}"><span>{{$order->name}}</span></a>
									<p class="price">
										制作希望価格：{{number_format($order->price)}}円
									</p>
									<p class="summary">
										{{$order->detail}}
									</p>
							...
							<div class="table_style mode_contact">
								<dl>
									...
									<dd>
										...
										<li>
											<label>
												<input type="radio" name="category_id" value="1"  @if(request()->input('category_id')==1) checked="checked" @endif > フルオーダー
											</label>
										</li>
										<li>
											<label>
												<input type="radio" name="category_id" value="2"  @if(request()->input('category_id')==2) checked="checked" @endif> セミオーダー
											</label>
										</li>
										<li>
											<label>
												<input type="radio" name="category_id" value="3"  @if(request()->input('category_id')==3) checked="checked" @endif> リフォーム
											</label>
										</li>
										<li>
											<label>
												<input type="radio" name="category_id" value="4"  @if(request()->input('category_id')==4) checked="checked" @endif> デザインのみ
											</label>
										</li>
										<li class="fs">
											素材
										...
										<li>
											<label>
												<input type="radio" name="category_id" value="5"  @if(request()->input('category_id')==5) checked="checked" @endif> 素材を探す
											</label>
										</li>
										<li>
											<label>
												<input type="radio" name="category_id" value="6"  @if(request()->input('category_id')==6) checked="checked" @endif> 素材を依頼する
											</label>
										</li>
										<li class="fs">
											修理・リサイクル
										...
										<li>
											<label>
												<input type="radio" name="category_id" value="7"  @if(request()->input('category_id')==7) checked="checked" @endif> 修理
											</label>
										</li>
										<li>
											<label>
												<input type="radio" name="category_id" value="8"  @if(request()->input('category_id')==8) checked="checked" @endif> サイズ直し
											</label>
										</li>
										<li>
											<label>
												<input type="radio" name="category_id" value="9"  @if(request()->input('category_id')==9) checked="checked" @endif> 売却
											</label>
										</li>
										<li>
											<label>
												<input type="radio" name="category_id" value="10"  @if(request()->input('category_id')==10) checked="checked" @endif> 査定
											</label>
										</li>
										<li class="fs">
											相談
										...
										<li>
											<label>
												<input type="radio" name="category_id" value="11"  @if(request()->input('category_id')==11) checked="checked" @endif> アドバイス
											</label>
										</li>
										<li>
											<label>
												<input type="radio" name="category_id" value="12"  @if(request()->input('category_id')==12) checked="checked" @endif> コーディネート
											</label>
										</li>
										<li>
											<label>
												<input type="radio" name="category_id" value="13"  @if(request()->input('category_id')==13) checked="checked" @endif> 問い合わせ
											</label>
										</li>
										<li>
											<label>
												<input type="radio" name="category_id" value="14"  @if(request()->input('category_id')==14) checked="checked" @endif> その他
											</label>
										</li>
										</ul>
									</dd>
