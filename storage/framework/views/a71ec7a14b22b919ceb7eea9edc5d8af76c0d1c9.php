				...
				<div class="modal modal_flom_baloon is-show">
					<div class="inner">
						...
						<div class="cont">
							<div class="txt_box">
								<p>
									TOPページの「このような方にご利用いただいています」の「<?php echo e($text, false); ?>」内容をSTEP2の「カテゴリー」、STEP3の「タグ」に反映しています（ほかにも適切なものがありましたら選択してください）。
								</p>
								<p>
							...
							<dl class="example">
								...
								<dd>
									<?php echo e($category_name, false); ?>
...
<!-- 										<li class="fs">
				...
				<form method="post" action="/order" enctype='multipart/form-data'><?php echo csrf_field(); ?>
					<div class="step_box">
							...
							<div class="txt_box">
								...
								<div class="table_style mode_contact">
									<dd>
										...
										<li>
											<label>
												<input type="radio" name="category_id" value="1"  <?php if(old('category_id')==1): ?> checked="checked" <?php endif; ?> > フルオーダー
											</label>
										</li>
										<li>
											<label>
												<input type="radio" name="category_id" value="2"  <?php if(old('category_id')==2): ?> checked="checked" <?php endif; ?>> セミオーダー
											</label>
										</li>
										<li>
											<label>
												<input type="radio" name="category_id" value="3"  <?php if(old('category_id')==3): ?> checked="checked" <?php endif; ?>> リフォーム
											</label>
										</li>
										<li>
											<label>
												<input type="radio" name="category_id" value="4"  <?php if(old('category_id')==4): ?> checked="checked" <?php endif; ?>> デザインのみ
											</label>
										</li>
										<li class="fs">
											素材
										...
										<li>
											<label>
												<input type="radio" name="category_id" value="5"  <?php if(old('category_id')==5): ?> checked="checked" <?php endif; ?>> 素材を探す
											</label>
										</li>
										<li>
											<label>
												<input type="radio" name="category_id" value="6"  <?php if(old('category_id')==6): ?> checked="checked" <?php endif; ?>> 素材を依頼する
											</label>
										</li>
										<li class="fs">
											修理・リサイクル
										...
										<li>
											<label>
												<input type="radio" name="category_id" value="7"  <?php if(old('category_id')==7): ?> checked="checked" <?php endif; ?>> 修理
											</label>
										</li>
										<li>
											<label>
												<input type="radio" name="category_id" value="8"  <?php if(old('category_id')==8): ?> checked="checked" <?php endif; ?>> サイズ直し
											</label>
										</li>
										<li>
											<label>
												<input type="radio" name="category_id" value="9"  <?php if(old('category_id')==9): ?> checked="checked" <?php endif; ?>> 売却
											</label>
										</li>
										<li>
											<label>
												<input type="radio" name="category_id" value="10"  <?php if(old('category_id')==10): ?> checked="checked" <?php endif; ?>> 査定
											</label>
										</li>
										<li class="fs">
											相談
										...
										<li>
											<label>
												<input type="radio" name="category_id" value="11"  <?php if(old('category_id')==11): ?> checked="checked" <?php endif; ?>> アドバイス
											</label>
										</li>
										<li>
											<label>
												<input type="radio" name="category_id" value="12"  <?php if(old('category_id')==12): ?> checked="checked" <?php endif; ?>> コーディネート
											</label>
										</li>
										<li>
											<label>
												<input type="radio" name="category_id" value="13"  <?php if(old('category_id')==13): ?> checked="checked" <?php endif; ?>> 問い合わせ
											</label>
										</li>
										<li>
											<label>
												<input type="radio" name="category_id" value="14"  <?php if(old('category_id')==14): ?> checked="checked" <?php endif; ?>> その他
											</label>
										</li>
										</ul>
									</dd>
							...
							<div class="txt_box">
								...
								<div class="table_style mode_contact">
									<dl>
										...
										<dd>
											<textarea name="detail" class="resize" style="overflow: hidden; overflow-wrap: break-word; resize: none; height: 62px;"><?php echo e(old('detail'), false); ?></textarea>
										</dd>
									</dl>
								</div>
							</div>
...
<dd>
									...
									<dl>
										...
										<dd>
											<textarea name="annotation01" class="resize" style="overflow: hidden; overflow-wrap: break-word; resize: none; height: 62px;"><?php echo e(old('annotation01'), false); ?></textarea>
										</dd>
									</dl>
									<dl>
										<dt class="any">
									...
									<dl>
										...
										<dd>
											<textarea name="annotation02" class="resize" style="overflow: hidden; overflow-wrap: break-word; resize: none; height: 62px;"><?php echo e(old('annotation02'), false); ?></textarea>
										</dd>
									</dl>
									<dl>
										<dt class="any">
									...
									<dl>
										...
										<dd>
											<textarea name="annotation03" class="resize" style="overflow: hidden; overflow-wrap: break-word; resize: none; height: 62px;"><?php echo e(old('annotation03'), false); ?></textarea>
										</dd>
									</dl>
								</div>
							</div>
							...
							<div class="txt_box">
								...
								<div class="table_style mode_contact">
									<dl>
										...
										<dd>
											<input type="date" name="limit_date1" value="<?php echo e(old('limit_date1'), false); ?>" required="required">
										</dd>
									</dl>
								</div>
							</div>
							...
							<div class="txt_box">
								...
								<div class="table_style mode_contact">
									<dl>
										...
										<dd>
											<input type="date" name="limit_date2" value="<?php echo e(old('limit_date2'), false); ?>">
										</dd>
									</dl>
								</div>
							</div>
...
<?php echo $__env->make('layouts.app', ['title' => '発注チュートリアル'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/raindiamond/ai-jewelly.com/resources/views/tutorial/index.blade.php ENDPATH**/ ?>