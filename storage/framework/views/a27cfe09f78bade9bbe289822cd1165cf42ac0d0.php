			...
			<div class="container">
				...
				<nav class="breadcrumbs">
					<ul>
						...
						<li><a href="../index.html">マイメニュー</a></li>
					...
					<ul class="message_li">
						...
						<li>
							...
							<div class="data">
								...
								<?php if($messageList->file): ?>
								<div class="file">
									DL：<a href="/mymenu/message/dl/<?php echo e($messageList->id, false); ?>" download="<?php echo e($messageList->org_file_name, false); ?>"><?php echo e($messageList->org_file_name, false); ?></a>
								</div>
								<?php endif; ?>
							</div>
						</li>
...
<?php echo $__env->make('layouts.app', ['title' => $order->name.'｜メッセージ｜マイメニュー','css'=>'mymenu'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/raindiamond/ai-jewelly.com/resources/views/mymenu/message/detail.blade.php ENDPATH**/ ?>