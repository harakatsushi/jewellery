                        ...
                        <?php else: ?>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <?php if(Auth::guard('web')->user()->role==1 || Auth::guard('web')->user()->role==2): ?> 
                                    <a class="dropdown-item" href="/csv">
                                        CSV
                                    </a>
                                    <?php endif; ?>
                                    <?php if(Auth::guard('web')->user()->role!=5): ?> 
                                     <a class="dropdown-item" href="/acquisitions">
                                        獲得管理
                                    </a>
                                    <?php endif; ?>
                                     <?php if(Auth::guard('web')->user()->role==1 || Auth::guard('web')->user()->role==2 || Auth::guard('web')->user()->role==3): ?> 
                                    <a class="dropdown-item" href="/yamato">
                                        ヤマト到着確認機能
                                    </a>
                                     <?php endif; ?>
                                     <?php if(Auth::guard('web')->user()->role==1 || Auth::guard('web')->user()->role==2): ?> 
                                     <a class="dropdown-item" href="/analyze">
                                        進捗確認
                                    </a>
                                    <?php endif; ?>
