			...
			<main id="cont_main">
				...
				<section id="sec_prod" class="mid_sec">
					...
					<ul class="item_box mode_menu">
						...
						<li>
							<button onclick="addBookmark('menu',<?php echo e($menu->id, false); ?>)" class="btn_favo mode_s <?php if($bookmarks && $bookmarks->contains('item_id',$menu->id)): ?> active <?php endif; ?>"></button>
...
<?php echo $__env->make('layouts.app', ['title' => 'メニュー'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/raindiamond/ai-jewelly.com/resources/views/menu/index.blade.php ENDPATH**/ ?>