			...
			<main id="cont_main">
				...
				<section id="sec_prod" class="mid_sec">
					...
					<ul class="item_box mode_material">
						...
						<li>
							<button  onclick="addBookmark('material',<?php echo e($material->id, false); ?>)" class="btn_favo mode_s <?php if($bookmarks && $bookmarks->contains('item_id',$material->id)): ?> active <?php endif; ?>"></button>
...
<?php echo $__env->make('layouts.app', ['title' => '素材・デザイン'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/raindiamond/ai-jewelly.com/resources/views/material/index.blade.php ENDPATH**/ ?>