		...
		<div id="cont_wrapper" class="container u_page">
          ...
          <?php endif; ?>
								<dl>
									...
									<dd>
										<div class="img_box mode_thum btn_mb">
											<img src="/upload/profile/<?php echo e($product->image, false); ?>" alt="" id="preview">
										</div>
								...
								<dl>
									...
									<dd>
										<div class="img_box mode02 btn_mb <?php if(!$product->sub_img1): ?> disp_n <?php endif; ?>">
											<img src="/upload/profile/<?php echo e($product->sub_img1, false); ?>" alt="" id="preview01">
										</div>
										<div class="file_input">
								...
								<dl>
									...
									<dd>
										<div class="img_box mode02 btn_mb  <?php if(!$product->sub_img2): ?> disp_n <?php endif; ?>">
											<img src="/upload/profile/<?php echo e($product->sub_img2, false); ?>" alt="" id="preview02">
										</div>
										<div class="file_input">
								...
								<dl>
									...
									<dd>
										<div class="img_box mode02 btn_mb  <?php if(!$product->sub_img3): ?> disp_n <?php endif; ?>">
											<img src="/upload/profile/<?php echo e($product->sub_img3, false); ?>" alt="" id="preview03">
										</div>
										<div class="file_input">
...
<?php echo $__env->make('layouts.app', ['title' => '【編集】'.$product->name.'｜作品登録｜ジュエラーメニュー','css'=>'mymenu'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/raindiamond/ai-jewelly.com/resources/views/jewellermenu/product/edit.blade.php ENDPATH**/ ?>