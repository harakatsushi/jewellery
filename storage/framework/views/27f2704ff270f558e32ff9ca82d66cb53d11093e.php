                    ...
                    <ul class="item_box mode_material">
                        ...
                        <li>
                            ...
                            <a href="/jeweller/material/detail/<?php echo e($material->id, false); ?>">
                                ...
                                <div class="data">
                                    <ul class="tag_li">
                                        <?php $__currentLoopData = $material->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ind=> $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($ind<1): ?>
                                        <li><?php echo e($tag->name, false); ?> <?php if(count($material->tags)>1): ?> etc <?php endif; ?></li>
                                        <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                    <p class="txt"><?php echo e($material->name, false); ?></p>
                                </div>
                            </a>
                        </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <a href="/jeweller/menu/detail/<?php echo e($menu->id, false); ?>">
                                <div class="img_box mode_thum">
                                    ...
                                    <div class="data">
                                        <?php if($menu->price): ?>
                                        <ul class="tag_li">
                                            <li class="price"><?php echo e(number_format($menu->price), false); ?>円~</li>
                                        </ul>
                                        <?php endif; ?>
                                        <p class="txt"><?php echo e($menu->name, false); ?></p>
                                    </div>
                                </div>
                            </a>
                        </li>
            ...
            <section id="sec_juweller" class="sec_area sec_border">
                <div class="container">
                    ...
                    <ul class="item_box mode_menu mode02">
                        ...
                        <li>
                            <button class="btn_favo mode_s <?php if($jeweller_bookmarks && $jeweller_bookmarks->contains('item_id',$jeweller->id)): ?> active <?php endif; ?>)" onclick="addBookmark('jeweller',<?php echo e($jeweller->id, false); ?>)"></button>
...
<?php echo $__env->make('layouts.app', ['css' => 'top'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/raindiamond/ai-jewelly.com/resources/views/index.blade.php ENDPATH**/ ?>