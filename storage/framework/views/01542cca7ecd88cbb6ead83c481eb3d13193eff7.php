...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">支部ログイン</div>

                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('branch_login_post'), false); ?>">
                        <?php echo csrf_field(); ?>

                                        <strong><?php echo e($error, false); ?></strong>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/branch/login.blade.php ENDPATH**/ ?>