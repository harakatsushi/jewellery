		...
		<div id="cont_wrapper" class="container u_page mode_item">
			<main id="cont_main">
				...
				<section id="sec_prod" class="mid_sec">
					...
					<p class="sort_box">
						<select name="" id=""  onchange="chgSort('product',this.value)">
							<option value="0" <?php if($sort_number==0): ?> selected <?php endif; ?>>おすすめ</option>
							<option value="1" <?php if($sort_number==1): ?> selected <?php endif; ?>>新着順</option>
						</select>
					</p>
					<ul class="prod_li mode02">
						<?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<li><button  onclick="addBookmark('product',<?php echo e($product->id, false); ?>)" class="btn_favo mode_s <?php if($bookmarks && $bookmarks->contains('item_id',$product->id)): ?> active <?php endif; ?>"></button><a href="/jeweller/product/detail/<?php echo e($product->id, false); ?>"><img src="/upload/profile/<?php echo e($product->image, false); ?>" alt=""></a></li>
...
<?php echo $__env->make('layouts.app', ['title' => '制作実績'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/raindiamond/ai-jewelly.com/resources/views/product/index.blade.php ENDPATH**/ ?>