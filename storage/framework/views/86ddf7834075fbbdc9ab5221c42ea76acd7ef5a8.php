				...
				<dl class="menu_box narrow_box tag_dl">
					...
					<dd>
						<form >
							...
							<p class="btn_mt">
								<a href="/operationmenu/favorite" class="fs">
									全て表示
								</a>
							</p>
						</form>
...
<?php echo $__env->make('layouts.app', ['title' => 'お気に入り｜運営メニュー','css'=>'mymenu'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/raindiamond/ai-jewelly.com/resources/views/operationmenu/favorite/index.blade.php ENDPATH**/ ?>