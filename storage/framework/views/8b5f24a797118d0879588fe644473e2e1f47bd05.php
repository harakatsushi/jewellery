...
<div class="container">
    ...
    <div class="row justify-content-left">
       <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="/branch/excel">
                        <?php echo csrf_field(); ?>
                        <span style="color: red"><?php echo e($error, false); ?></span>
...
<?php echo $__env->make('layouts.app_branch', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/branch/home.blade.php ENDPATH**/ ?>