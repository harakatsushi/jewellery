		...
		<div id="cont_wrapper" class="container u_page">
          ...
          <?php endif; ?>
								<dl>
									...
									<dd>
										<div class="img_box mode_thum btn_mb">
											<img src="/upload/profile/<?php echo e($material->image, false); ?>" alt="" id="preview">
										</div>
								...
								<dl>
									...
									<dd>
										<input type="text" name="name" value="<?php echo e(old('name'), false); ?>" placeholder="作品名を入力してください" required="required">
									</dd>
								</dl>
								<dl>
									<dt class="any">
								...
								<dl>
									...
									<dd>
										<div class="img_box mode02 btn_mb <?php if(!$material->sub_img1): ?> disp_n <?php endif; ?>">
											<img src="/upload/profile/<?php echo e($material->sub_img1, false); ?>" alt="" id="preview01">
										</div>
										<div class="file_input">
								...
								<dl>
									...
									<dd>
										<div class="img_box mode02 btn_mb  <?php if(!$material->sub_img2): ?> disp_n <?php endif; ?>">
											<img src="/upload/profile/<?php echo e($material->sub_img2, false); ?>" alt="" id="preview02">
										</div>
										<div class="file_input">
								...
								<dl>
									...
									<dd>
										<div class="img_box mode02 btn_mb  <?php if(!$material->sub_img3): ?> disp_n <?php endif; ?>">
											<img src="/upload/profile/<?php echo e($material->sub_img3, false); ?>" alt="" id="preview03">
										</div>
										<div class="file_input">
...
<?php echo $__env->make('layouts.app', ['title' => '【編集】'.$material->name.'｜素材・デザイン登録｜ジュエラーメニュー','css'=>'mymenu'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/raindiamond/ai-jewelly.com/resources/views/jewellermenu/material/edit.blade.php ENDPATH**/ ?>