			...
			<div class="container">
				...
				<nav class="breadcrumbs">
					<ul>
						...
						<li><a href="./index.html">メニュー一覧</a></li>
						<li>メニュー名</li>
					</ul>
				</nav>
			</div>
		...
		<div id="cont_wrapper" class="container u_page mode_item">
			<main id="cont_main">
				<section id="my_favo" class="mid_sec">
					...
					<?php if($menu->sub_img1): ?>
						<div class="postscript_box txt_box">
							<div class="img_box">
								<img src="/upload/profile/<?php echo e($menu->sub_img1, false); ?>" alt="<?php echo e($menu->name, false); ?>">
							</div>
							<p>
								<?php echo e($menu->annotation01, false); ?>

							</p>
						</div>
						<?php endif; ?>
						<?php if($menu->sub_img2): ?>
						<div class="postscript_box txt_box">
							<div class="img_box">
								<img src="/upload/profile/<?php echo e($menu->sub_img2, false); ?>" alt="<?php echo e($menu->name, false); ?>">
							</div>
							<p>
								<?php echo e($menu->annotation02, false); ?>

							</p>
						</div>
						<?php endif; ?>
						<?php if($menu->sub_img3): ?>
						<div class="postscript_box txt_box">
							<div class="img_box">
								<img src="/upload/profile/<?php echo e($menu->sub_img3, false); ?>" alt="<?php echo e($menu->name, false); ?>">
							</div>
							<p>
								<?php echo e($menu->annotation03, false); ?>
						...
						<dl class="price_box">
							...
							<dd>
								<?php echo e(number_format($menu->price), false); ?>円 <?php if($menu->price_option==2): ?> ～ <?php endif; ?>
							</dd>
						</dl>
						<?php endif; ?>
					</div>
...
<?php echo $__env->make('layouts.app', ['title' =>$menu->name .'｜作品一覧｜'.$jeweller->name.'さん｜在籍ジュエラー'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/raindiamond/ai-jewelly.com/resources/views/jeweller/menu/detail.blade.php ENDPATH**/ ?>