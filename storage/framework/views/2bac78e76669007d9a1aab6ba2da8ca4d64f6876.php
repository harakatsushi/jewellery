		...
		<div id="cont_wrapper" class="container u_page mode_item">
          ...
          <?php endif; ?>
						...
						<p class="btn_mt btn_mb">
							<input type="submit" class="btn01" value="依頼を募集する">
						</p>
					</form>
					<p class="btn_mt">
...
<?php echo $__env->make('layouts.app', ['title' => '制作依頼'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/raindiamond/ai-jewelly.com/resources/views/order/index.blade.php ENDPATH**/ ?>