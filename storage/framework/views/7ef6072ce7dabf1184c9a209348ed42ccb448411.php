...
<head>
    ...
    <title><?php echo e(config('app.name', 'Laravel'), false); ?>(支部)</title>
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="<?php echo e(url('/'), false); ?>/home">
                    <?php echo e(config('app.name', 'Laravel'), false); ?>(支部)
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/branch/logout">ログアウト</a>
                            </li>
                        ...
                        <?php else: ?>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                     <a class="dropdown-item" href="/csv">
                                        home
                                    </a>
...
<?php /**PATH /var/www/html/resources/views/layouts/app_branch.blade.php ENDPATH**/ ?>