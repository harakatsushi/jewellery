       ...
       <?php if(count($errors) > 0): ?>
          ...
          <?php endif; ?>
								<dl>
									...
									<dd>
										<div class="img_box mode_thum btn_mb">
											<img src="/upload/profile/<?php echo e($menu->image, false); ?>" alt="" id="preview">
										</div>
								...
								<dl>
									...
									<dd>
										<div class="img_box mode02 btn_mb <?php if(!$menu->sub_img1): ?> disp_n <?php endif; ?>">
											<img src="/upload/profile/<?php echo e($menu->sub_img1, false); ?>" alt="" id="preview01">
										</div>
										<div class="file_input">
								...
								<dl>
									...
									<dd>
										<div class="img_box mode02 btn_mb  <?php if(!$menu->sub_img2): ?> disp_n <?php endif; ?>">
											<img src="/upload/profile/<?php echo e($menu->sub_img2, false); ?>" alt="" id="preview02">
										</div>
										<div class="file_input">
								...
								<dl>
									...
									<dd>
										<div class="img_box mode02 btn_mb  <?php if(!$menu->sub_img3): ?> disp_n <?php endif; ?>">
											<img src="/upload/profile/<?php echo e($menu->sub_img3, false); ?>" alt="" id="preview03">
										</div>
										<div class="file_input">
...
<?php echo $__env->make('layouts.app', ['title' => '【編集】'.$menu->name.'｜作品登録｜ジュエラーメニュー','css'=>'mymenu'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/raindiamond/ai-jewelly.com/resources/views/jewellermenu/menu/edit.blade.php ENDPATH**/ ?>