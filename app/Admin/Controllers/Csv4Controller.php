...
class Csv4Controller extends AdminController
{
    /**
...
// 作成したImportButtonをツールに表示
        $grid->tools(function ($tools) {
            $tools->append(new ImportButton('csv4s'));
        });
    ...
    {
        $show = new Show(Csv4::findOrFail($id));
